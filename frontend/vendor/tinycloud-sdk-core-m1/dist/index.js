...
var PersistedSessionDataSchema = z2.object({
   ...
   */
  tinycloudHosts: z2.array(z2.string()).optional()
});
...
var SpaceConfigSchema = z4.object({
  ...
  createSecrets: z4.function().optional(),
...
var SpaceServiceConfigSchema = z4.object({
  ...
  createSecretsService: z4.function().optional(),
...
import { bytesToHex as bytesToHex2, sha256 as sha2562, verifyMessage as verifyMessage2 } from "viem";
...
async function verifySignature(signature, digest) {
  if (signature.suite === ED25519_JCS_SIGNATURE_SUITE) {
    ...
    try {
      return ed255192.verify(signatureBytes, digest, publicKey);
    } catch {
...
function ed25519PublicKeyFromDidKey2(did) {
  ...
  let bytes;
  try {
    bytes = bases2.base58btc.decode(identifier);
  } catch {
