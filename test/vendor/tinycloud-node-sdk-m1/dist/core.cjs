...
var _TinyCloudNode = class _TinyCloudNode {
  ...
  async createOwnerDelegation(params) {
    ...
    const now = /* @__PURE__ */ new Date();
    if (params.expiresAt.getTime() <= now.getTime() || params.expiresAt.getTime() - now.getTime() > import_sdk_core8.EXPIRY.MAX_MS) {
    ...
    const activation = await (0, import_sdk_core8.activateSessionWithHost)(host, delegationSession.delegationHeader);
